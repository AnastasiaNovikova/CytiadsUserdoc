...
.. csv-table::
   ...
   "Яндекс.Деньги", "2000 ₽"
   "Все остальные типы счетов", "₽ |br| $, € и лругая валюта, кроме ₽" "2000 ₽ |br| Эквивалент 30 $"

Пожалуйста, обратите внимание:

* Если валюта вашего внутреннего счета отличается от валюты внешнего **Основного** счета (на который мы выводим средства), то за конвертацию мы взимаем коммисию — 3%от суммы перевода.

* Рассчет всех сумм при конвертации валют мы ведем по нашему курсу (в который уже вшиты конвертационные издержки) на дату операции. С курсом можно ознакомиться в разделе :guilabel:`Офис | Финансы и выплаты | Курс валют`.
