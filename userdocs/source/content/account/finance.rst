...
.. csv-table::
   :header: "Внешний счет", "Валюта внутреннего счета", "Минимальная выплата"
   :widths: 5, 5, 3
...
Есть некоторые особенности выплат, которые нужно знать:

* Если валюта внутреннего счета вебмастера отличается от валюты его внешнего **Основного** счета (на который мы выводим средства), то за конвертацию мы взимаем комиссию — 3% от суммы перевода.
...
* Если заработанных средств не хватает для того, чтобы  их вывести на внешний счет, то они останутся в системе на внутреннем счету. Как только минимальная сумма наберется, по *графику выплат* эти средства будут перечислены на :ref:`основной внешний счет <external-acc-label>`.
