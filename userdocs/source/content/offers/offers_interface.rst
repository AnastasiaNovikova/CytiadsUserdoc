...
#. **Активные офферы** это те, которые активны для вас на данный момент. То есть вы, вероятно, льете на них трафик.
...
#. По **Наименованию цели** можно понять, чего хочет рекламодатель.
...
Эта таблица говорит о том, какой тип трафика рекламодатель готов принять на своей стороне и не будет против. Подробно про типы трафика можно прочитать :ref:`выше <>` и ни в коем случае не использовать запрещенные!
