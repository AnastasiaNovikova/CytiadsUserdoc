...
* Какие бывают :ref:`статусы аккаунта <account-status-label>`.  :ref:`время одобрения и оплаты <from-click-to-payout-label>`
* Что такое :ref:`статусы аккаунта<account-status-label>` :ref:`время одобрения и оплаты<from-click-to-payout-label>`.
