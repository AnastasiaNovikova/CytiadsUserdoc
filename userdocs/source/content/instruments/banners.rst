...
#. Если проставить галочку у одного из ротаторов в таблице, то можно просмотреть его отдельную статистику, нажав кнопку **На диаграмме** или :guilabel:`Удалить` этот инструмент.
